...
| 6 | Proxy / Gateway / SDK / CLI — wire health routes, lock public surface | [06-proxy-sdk-cli.md](06-proxy-sdk-cli.md) | −1 (delete `compat_exports.py` if not already) |
| 7 | Agent integrations — extract base, per-agent diffs only | [07-integrations.md](07-integrations.md) | 0 |
