...
> **Start here** if you are implementing or reviewing LATTICE after Phase 9.
...
| Doc | Purpose |
|---|---|
| [STATUS.md](STATUS.md) | What shipped (Phases 0–9) + forward-plan summary |
...
2. [PHASE_GUIDELINES.md](PHASE_GUIDELINES.md) — template  
3. Your phase doc (e.g. `27-transport-layer-consolidation.md`)  
4. [SINGLE_SOURCE_OF_TRUTH.md](SINGLE_SOURCE_OF_TRUTH.md) — where to put code  
5. [STATUS.md](STATUS.md) — what already shipped  
